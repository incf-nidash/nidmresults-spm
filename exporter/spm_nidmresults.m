...
p.entity(idErrorModel,{...
    ...
    nidm_conv('nidm_hasErrorDistribution',p),nidm_conv(err_dist,p),...
    extra_fields_NM{:}});
...
for c=1:contrasts.Count
    ...
    p.entity(idConVec,{...
        ...
        nidm_conv('nidm_statisticType',p),nidm_conv(STAT,p),...
    ...
    p.entity(idSPM{c},{...
        ...
        'dct:format',niifmt,...
        'prov:label',{[upper(STAT) '-Statistic Map: ' nidm_esc(this_con_name)],'xsd:string'},...
        nidm_conv('nidm_statisticType',p),nidm_conv(STAT,p),...
        nidm_conv('nidm_contrastName',p),{nidm_esc(this_con_name),'xsd:string'},...
...
for i = 1:numel(equivHeightThreshNames)
    ...
    p.entity(idEquivHThresh,{...
        ...
        'prov:type',equivHThresh('nidm_HeightThreshold/prov:type'),...
...
for i = 1:numel(equivExtentThreshNames)
    ...
    p.entity(idEquivEThresh,{...
        ...
        'prov:type',equivEThresh('nidm_ExtentThreshold/prov:type'),...
...
switch(extent_thresh_type)
    ...
    case 'obo_statistic'
        ...
        extent_thresh_desc  = sprintf(': k>%s (unc.)',extent_thresh_value);
        extra_fields_extent(end+1:end+2) = {
...
search_space_attributes = {...
    ...
    nidm_conv('spm_searchVolumeReselsGeometry',p),{inference('nidm_SearchSpaceMaskMap/spm_searchVolumeReselsGeometry'),'xsd:string'},...
...
i = 1;
while true
    nidmfile = fullfile(spm_fileparts(outdir),sprintf('spm_%04d.nidm.zip',i));
